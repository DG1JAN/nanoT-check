...
***It comes with absolutely no guarantees and is Work in Progress!!***
...
- Start tcheck_qt.py (e.g. #python3 tcheck_qt.py) / or run binary (see link above)
...
Example of a connected Tee-Junction with a 50Ohm sma Plug (from the NanoVNA Calibration kit)
